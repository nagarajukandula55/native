...
export default function AdminProducts() {
  const hsnOptions = {
    ...
    "2103": 12,
    "2106": 18,
    // add more HSN => GST here if needed
  }
  ...
  function handleChange(e) {
    ...
    // Auto-set GST when HSN is selected
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "auto", padding: 30 }}>
      ...
      >
        ...
        <button
          disabled={saving}
          style={{ padding: 12, background: "black", color: "#fff", borderRadius: 6, cursor: "pointer", gridColumn: "span 2" }}
        >
              ...
              {products.length > 0 &&
                products.map(p => (
                  <tr key={p._id} style={{ borderBottom: "1px solid #eee" }}>
                    <td>{p.sku}</td>
                    <td>
                      <img src={p.image} style={{ width: 60, height: 60, objectFit: "cover" }} />
                    </td>
                    <td>{p.name}</td>
                    <td>{p.brand}</td>
                    <td>₹{p.price}</td>
                    ...
                    <td style={{ display: "flex", gap: "10px" }}>
                      <button
                        ...
                        style={{ background: "red", color: "#fff", padding: "6px 12px", borderRadius: "4px" }}
                      >
                        Delete
                      </button>
                    </td>
