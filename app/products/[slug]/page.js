  ...
  return (
    <div style={{ padding: "40px", fontFamily: "'Arial', sans-serif" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        {product.image && <img src={product.image} alt={product.alt} style={{ width: "100%", height: "400px", objectFit: "cover", borderRadius: "10px" }} />}
        <h1>{product.name}</h1>
        ...
        <button style={{ padding: "10px 15px", background: "#1890ff", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>Add to Cart</button>
      </div>
    </div>
  );
}
