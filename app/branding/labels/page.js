...
/* LIMIT INITIAL LOAD (scalable for thousands later) */
...
export default function Editor() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh" }}>
      {/* LEFT PANEL */}
      <div style={{ width: 220, background: "#111", color: "#fff", padding: 10, overflow: "auto" }}>
        <h3>Tools</h3>
        ...
        {iconKeys.map((key, i) => {
          ...
          return <div key={i} onClick={() => addIcon(key)} style={{ cursor: "pointer" }}><Icon /></div>;
        })}
      </div>
