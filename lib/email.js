...
export async function sendShipmentFailedEmail({
  ...
  return sendEmail({
    ...
    html: `
      ...
      <div style="font-family:Arial;padding:20px">
        ...
        <h2>
          Shipment Update Failed ⚠️
        </h2>

        <p>
          There was an issue while processing your shipment.
        </p>
        ...
        <p>
          Our support team is reviewing the issue.
        </p>
...
export async function sendShipmentOutForDeliveryEmail({
  ...
  return sendEmail({
    ...
    subject:
      `Out For Delivery - ${order.orderId}`,
